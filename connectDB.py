...
def get_newest_emotion_id(userID):
    datas = query_db('''select * from "learning_emotion" where "u_id"=%s and ("study_emotion"='sad' or "study_emotion"='angry' or "study_emotion"='disgusted') order by "id" desc limit 1''', [userID])
    return datas[0]["id"]

def update_video_status(id, resume):
